...
<schema xmlns="http://purl.oclc.org/dsdl/schematron"
  ...
  <!-- V1.09.1 - some additional change : BR-FXEXT-S01, E-01, ... + Card BT-151  -->
  ...
  <pattern> 
    <rule context="//ram:ApplicableProductCharacteristic">
      <!-- V1.09.1 Règle désactivée dans l'EXTENDED-CTC-FR replaved with BR-FREXT-54-1 et BR-FREXT-54-2
	...
	-->
      <assert id="BR-FREXT-54-1" flag="fatal" test="exists(ram:Description) or exists(ram:TypeCode)">
        [BR-FXEXT-BR-54-1]-Each Item attribute (BG-32) shall contain an Item attribute name (BT-160) or an Item attribute Code (BT-X-11/EXT-FR-FE-159).</assert>
      <assert id="BR-FREXT-54-2" flag="fatal" test="(exists(ram:Value) and not(exists(ram:ValueMeasure))) or (not(exists(ram:Value)) and (exists(ram:ValueMeasure[@unitCode!=''])))">
        [BR-FXEXT-BR-54-2]-Each Item attribute (BG-32) shall contain an Item attribute Value (BT-161) or an Item ValueQuantity (BT-X-12/EXT-FR-FE-160) with @unitCode (BT-X-12-0/EXT-FR-FE-161) and not both.</assert>     
      <!-- end of change -->      
    </rule>    
  </pattern>
  <pattern>
  ...
  <!-- V1.09.1 correction following Cardinality Change to 0..1
    ...
    -->
      <assert test="(../ram:SpecifiedLineTradeSettlement/ram:ApplicableTradeTax/ram:TypeCode = &apos;VAT&apos;) and (../ram:SpecifiedLineTradeSettlement/ram:ApplicableTradeTax[upper-case(ram:TypeCode) = &apos;VAT&apos;]/ram:CategoryCode)">             
        [BR-FXEXT-CO-04]-Each Invoice line (BG-25) shall be categorized with an Invoiced item VAT category code (BT-151) if the "Subtype of invoice line item" (BT-X-8) has the value "Normal line item (standard case)" (DETAIL) or is not specified.</assert>    
  ...
  <!-- V1.09.1 - Rule disabled in EXTENDED-CTC-FR / Règle désactivée dans l'EXTENDED-CTC-FR - replaced by FR-BR-X-01 in order to allow multiple VAT Breakdown lines per Categorie  
...
<!-- V1.09.1 - Cardinality changed to 0..1 
      <assert test="count(ram:TypeCode)=1">
	Element 'ram:TypeCode' must occur exactly 1 times.</assert>
      <assert test="count(ram:CategoryCode)=1">
	Element 'ram:CategoryCode' must occur exactly 1 times.</assert>
